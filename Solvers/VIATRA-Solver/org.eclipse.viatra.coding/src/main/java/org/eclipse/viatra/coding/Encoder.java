...
public class Encoder {
    ...
    private Map<Node, Integer> nodeCerts;

    public Encoder() {
        certificate = new BinaryCertificatePropagator();
    }

    public Encoder(CertificatePropagator certificate) {
        this.certificate = certificate;
    }
    
    public Map<Node, Integer> getNodeCerts() {
    	return nodeCerts;
    }

    public void calculateNodeCerts(Graph g) {
    ...
    public Object calculateStateCodeFromNodeCerts(Graph g, IStateCode s) {
    	return s.processStateCode(g, nodeCerts);
    }
    
    public Object calculateStateCode(Graph g, IStateCode s) {
    	calculateNodeCerts(g);
    	return s.processStateCode(g, nodeCerts);
    }
