...
public class PreliminaryTest {
    ...
    public void testEncoding() {
        assertNotNull(graph);
        Encoder e = new Encoder(new Encoder.NativeHashCertificatePropagator());
        Object value = e.calculateStateCode(graph, new AdjacencyStateCode(10));
        Object isomorphicValue = e.calculateStateCode(isomorphicGraph, new AdjacencyStateCode(10));
