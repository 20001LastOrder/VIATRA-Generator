...
public final class SupertypePlus extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private SupertypePlus() {
   ...
   * 
   */
  public static SupertypePlus instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link SupertypePlus} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SupertypePlus#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SupertypePlus INSTANCE = new SupertypePlus();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SupertypePlus.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.dslreasoner.viatrasolver.logic2viatra.queries.supertypePlus";
    }
