...
public final class SupertypeEdge extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private SupertypeEdge() {
   ...
   * 
   */
  public static SupertypeEdge instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link SupertypeEdge} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SupertypeEdge#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SupertypeEdge INSTANCE = new SupertypeEdge();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SupertypeEdge.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.dlsreasoner.alloy.reasoner.queries.supertypeEdge";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_type1, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.bme.hu/mit/inf/dslreasoner/logic/model/language", "Type", "supertypes")));
          ...
          new Equality(body, var__virtual_0_, var_type2);
          bodies.add(body);
      }
      return bodies;
    }
