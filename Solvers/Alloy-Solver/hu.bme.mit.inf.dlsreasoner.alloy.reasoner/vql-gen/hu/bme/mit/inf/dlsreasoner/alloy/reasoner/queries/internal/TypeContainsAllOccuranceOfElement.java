...
public final class TypeContainsAllOccuranceOfElement extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private TypeContainsAllOccuranceOfElement() {
   ...
   * 
   */
  public static TypeContainsAllOccuranceOfElement instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link TypeContainsAllOccuranceOfElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TypeContainsAllOccuranceOfElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TypeContainsAllOccuranceOfElement INSTANCE = new TypeContainsAllOccuranceOfElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TypeContainsAllOccuranceOfElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.dlsreasoner.alloy.reasoner.queries.typeContainsAllOccuranceOfElement";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find typeDoesNotCoverElementOccurance(element,type,_)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_element, var_type, var___0_), TypeDoesNotCoverElementOccurance.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
