...
public final class CommonSubtype extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private CommonSubtype() {
   ...
   * 
   */
  public static CommonSubtype instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link CommonSubtype} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CommonSubtype#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CommonSubtype INSTANCE = new CommonSubtype();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CommonSubtype.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.dlsreasoner.alloy.reasoner.queries.commonSubtype";
    }
