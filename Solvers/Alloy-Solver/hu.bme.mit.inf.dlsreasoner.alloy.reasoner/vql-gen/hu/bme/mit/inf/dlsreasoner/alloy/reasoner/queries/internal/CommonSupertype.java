...
public final class CommonSupertype extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
   ...
   * 
   */
  public static CommonSupertype instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link CommonSupertype} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CommonSupertype#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CommonSupertype INSTANCE = new CommonSupertype();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CommonSupertype.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.dlsreasoner.alloy.reasoner.queries.commonSupertype";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find supertype(common,type1)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_common, var_type1), Supertype.instance().getInternalQueryRepresentation());
          // 	find supertype(common,type2)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_common, var_type2), Supertype.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
